...
# -> Done in Terminal with "rails generate model ###" command
...
new_studio2 = Studio.new
new_studio2["name"] = "Paramount Pictures"
new_studio2.save
...
new_role10["actor_id"] = Actor.find_by({"name" => "Katie Holmes"})["id"]
